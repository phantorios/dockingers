"use strict";
var KTDatatablesBasicPaginations={init:function(){
    $("#kt_datatable").DataTable(
    {responsive:!0,
        pagingType:"full_numbers",
        columnDefs:[
            {
                targets:-1,width:"125px",
                title:"Actions",orderable:!1,
                ...
                {
                    targets:9,width:"75px",render:function(t,a,s,l)
                    {
                        var i=
                            {
...
jQuery(document).ready((function(){KTDatatablesBasicPaginations.init()}));